...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            //se existirem registos nas tabelas, não insere dados
            ...
            Seller s3 = new Seller(3, "Alex Grey", "alex@gmail.com", new DateTime(1988, 4, 21), 2200.0, d1);
            Seller s4 = new Seller(4, "Martha Red", "martha@gmail.com", new DateTime(1993, 4, 21), 3000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(2000, 4, 21), 4000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "bob@gmail.com", new DateTime(1997, 4, 21), 3000.0, d2);
